 ...
 */
export class ExhibitionRoomView extends React.Component<Props, State> {
    ...
    return (
      <BasicLayout
        ...
        <div className={ classes.editorLayout }>
          ...
          <ElementNavigationPane title="Näyttelykohde" />
          <EditorView>
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(ExhibitionRoomView));