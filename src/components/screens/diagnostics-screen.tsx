...
// eslint-disable-next-line max-len
import { Exhibition, ExhibitionFloor, ExhibitionRoom, ExhibitionDevice, ExhibitionDeviceGroup, DeviceModel, RfidAntenna } from "../../generated/client";
  ...
  private renderRightPanel = () => {
    ...
    return (
      <DiagnosticsProperties
        ...
        deviceGroups={ selectedRoom ?
          deviceGroups.filter(group => group.roomId === selectedRoom.id) :
          []
        }
      />
    );
