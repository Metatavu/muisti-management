...
/**
 * Component for dashboard users view
 */
class DashboardUsersView extends React.Component<Props, State> {
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(DashboardUsersView));